...
public class ModuleTransformer implements IModuleTransformer {
	...
	public Module persistenceToEntity(ModulePersistence modulePersistence) {
		...
		moduleBuilder.identification(modulePersistence.getCode()).hour(modulePersistence.getHour()).id(modulePersistence.getId()).name(modulePersistence.getName());
